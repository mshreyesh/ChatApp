...
import com.example.chatapp.Fragments.APIServices;
...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                notify = true;
                String message;
                message = send_text.getText().toString();
    ...
    private void sendNotification(String receiver, final String user, final String message){
